...
kumartree:{[master;data;f;target;besterror;bestfeature;indx]
 ...
 / show "------------";
  ...
  nxtl:(raze temp),1;
  master1:master,enlist (nxtl;splitdata[1]);
  show "Left tree now";
  kumartree[master1;splitdata[1];f;target;10;"none";indx+1];

  nxtr: (raze temp),2;
  master1:master,enlist (nxtr;splitdata[2]);
  show "Right tree now";
  kumartree[master1;splitdata[2];f;target;10;"none";indx+1];
