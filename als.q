kals:{[i;X;Y]show i;t:inv((Y mmu (flip Y)) + lambda*I );t:t mmu Y;X:flip (t mmu (flip W));t:inv(((flip X) mmu X) + lambda*I );t:t mmu flip X;Y:(t mmu W);$[i<numiter;kals[i+1;X;Y];(X;Y)]}
